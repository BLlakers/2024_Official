 ...
 *
 * <p>We do this because it is unneccesary to recreate The MotorController, Limit switch, and
 * Encoder 2 times.
 */
public class HangerModule extends SubsystemBase {
   ...
   *
   * <p>It sets the position on the encoder to 0
   */
  ...
  /**
   * This void function runs {@link #MoveHang} and tells the Hanger to run at {@link
   * Hanger#s_hangSpeedUp}
  ...
  /**
   * Everytime we create a HangerModule object, the InitSendable will be dupcliated for that module.
   * Same thing with SwerveModule objects.
   */
   ...
   *
   * <p>But, If we wanted to have a sequence of actions happening (like us running it until a
   * certain point):
   *
   * <p>We would run a set of void functions in a singular command, not held in this class (Would be
   * in {@link Hanger}).
   *
