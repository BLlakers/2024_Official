...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    m_robotContainer.Get.DriveTrainSub().ZeroGyro().schedule();
  ...
  public void autonomousInit() {
    m_robotContainer.Get.IntakeSub().resetIntakeAngle();
    m_robotContainer.Get.DriveTrainSub().m_FieldRelativeEnable = false;
  ...
  public void teleopInit() {
    m_robotContainer.Get.DriveTrainSub().m_FieldRelativeEnable = true;
    if (m_autonomousCommand != null) {
